        ...
        <div className='flex items-center justify-center p-16 bg-second bg-cover bg-contain bg-center- bg-fixed'>
            <form action="#" onSubmit={handleSubmit} className='bg-white/40 dark:bg-slate-900/70 px-8 py-6 rounded-lg backdrop-blur w-[40rem]'>
                ...
                {/* <div className='flex flex-col w-full text-slate-900 dark:text-white my-4'>
                    ...
                    <select onChange={handleChange} className='text-slate-900 border-2 rounded p-2 my-1 text-lg w-full outline-none focus:border-slate-900' name='tableNumber' value={formData.tableNumber} id="tableNumber">
                        {
                            tableNumbers.map((table, index) => (
                                <option key={index} value={table}>{`table ${table}`}</option>
                            ))
                        }
                    </select>
                </div> */}
                {/* <div className='flex flex-col w-full text-slate-900 dark:text-white my-4'>
                    ...
                    <input type="date" id='date'  name="date" value={formData.date} onChange={handleChange} className='text-slate-900 border-2 rounded p-2 my-1 text-lg w-full outline-none focus:border-slate-900' />
                </div> */}
                ...
                <input type="submit" value="Submit" className='rounded bg-slate-900 text-white py-3 px-6' onClick={handleSubmit} />
            </form>
        </div>
    )
}
